# Copilot Project Instructions — Django

> These instructions guide Copilot to follow our project's architecture and coding rules when generating code, reviews, tests, and docs.
...
## Dataclasses as DTO (Data Transfer Object)

- DTOs are introduced to clearly define what data are being passed from one layer to another (e.g., from service to view).
- Use **pydantic dataclasses** ([docs](https://docs.pydantic.dev/latest/concepts/dataclasses/)) instead of regular Python dataclasses.
